...
case('atoms')
  ...
  if (nspecies < 1) then
    write(*,*)
    write(*,'("Error(readinput): nspecies < 1 : ",I8)') nspecies
    write(*,*)
    stop
  end if
...
case('maxatpstp','maxatmstp')
  ...
  if (maxatpstp < 1) then
    write(*,*)
    write(*,'("Error(readinput): maxatpstp < 1 : ",I8)') maxatpstp
    write(*,*)
    stop
  end if
...
case('maxlatvstp')
  ...
  if (maxlatvstp < 1) then
    write(*,*)
    write(*,'("Error(readinput): maxlatvstp < 1 : ",I8)') maxlatvstp
    write(*,*)
    stop
  end if
case('tau0latv')
...
case('lradstp')
  ...
  if (lradstp < 1) then
    write(*,*)
    write(*,'("Error(readinput): lradstp < 1 : ",I8)') lradstp
    write(*,*)
    stop
  end if
case('chgexs')
...
case('noptcomp')
  ...
  if ((noptcomp < 1).or.(noptcomp > 27)) then
    write(*,*)
    write(*,'("Error(readinput): noptcomp should be from 1 to 27 : ",I8)') &
     noptcomp
    write(*,*)
    stop
  end if
...
case('phwrite')
  ...
  if (nphwrt < 1) then
    write(*,*)
    write(*,'("Error(readinput): nphwrt < 1 : ",I8)') nphwrt
    write(*,*)
    stop
  end if
  if (allocated(vqlwrt)) deallocate(vqlwrt)
...
case('tm3fix')
  ...
  if (ntmfix < 1) then
    write(*,*)
    write(*,'("Error(readinput): ntmfix < 1 : ",I8)') ntmfix
    write(*,*)
    stop
  end if
...
case('npole')
  ...
  if (npole < 1) then
    write(*,*)
    write(*,'("Error(readinput): npole < 1 : ",I8)') npole
    write(*,*)
    stop
  end if
case('nspade')
  ...
  if (nspade < 1) then
    write(*,*)
    write(*,'("Error(readinput): nspade < 1 : ",I8)') nspade
    write(*,*)
    stop
  end if
case('tfav0')
